    ...
    <div class="col-md-12">
        <form action="" method="post">
            <div class="form-group mb-2">
                ...
                value="<?= $userData['name']; ?>"
                require class="form-control" id="name">
            </div>
            <div class="form-group mb-2">
            ...
            <div class="form-group mb-2">
               ...
               name="gender" value="male">Male</label> &ensp;
               <label> <input type="radio" 
            ...
            <div class="form-group mb-2">
               ...
               <?=in_array('nepali',$language) ? 'checked' : ""?>
               name="language[]" value="nepali">Nepali</label> &ensp;
               <label> <input type="checkbox"
               <?=in_array('english',$language) ? 'checked' : ""?>
               name="language[]" value="english">English</label>
               <label> <input type="checkbox" 
               <?=in_array('chinese',$language) ? 'checked' : ""?>
               name="language[]" value="chinese">Chinese</label>
            </div>
            <div class="form-group mb-3">
                <label for="country">Country</label>
                <select name="country" id="country" class="form-control">
                    <option 
                    <?= $userData['country']=='nepal' ? 'selected' : ''?>
                    value="nepal">Nepal</option>
                    <option 
                    <?= $userData['country']=='china' ? 'selected' : ''?>
